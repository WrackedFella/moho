...
use super::event_setup::{setup_event_bus, EventBusSetup};
...
impl AppInitializer {
    ...
    pub fn build(self) -> Result<InitializedApp, AppInitError> {
        ...
        let mut input_system = InputSystem::new_with_preset(
...
mod tests {
    ...
    fn test_build_creates_all_systems() {
        ...
        assert_eq!(initialized.mouse_sensitivity, AppConfig::default().mouse_sensitivity);
        assert_eq!(initialized.frame_duration, Duration::from_secs_f64(1.0 / 60.0));
    }
    ...
    fn test_build_initializes_camera() {
        ...
        assert_ne!(view, glam::Mat4::IDENTITY, "View matrix should not be identity");
        assert_ne!(proj, glam::Mat4::IDENTITY, "Projection matrix should not be identity");
        assert_ne!(eye, glam::Vec3::ZERO, "Camera position should not be at origin");
    }
