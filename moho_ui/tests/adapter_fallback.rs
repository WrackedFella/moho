...
fn fallback_press_release_load_triggers_loadscene() {
    ...
    let new_rect = egui::Rect::from_min_size(egui::pos2(8.0, 48.0), egui::vec2(120.0, 32.0));
    let set_rect = egui::Rect::from_min_size(egui::pos2(8.0, 88.0), egui::vec2(120.0, 32.0));
    let exit_rect = egui::Rect::from_min_size(egui::pos2(8.0, 128.0), egui::vec2(120.0, 32.0));
    ui.test_set_button_rects(load_rect, new_rect, set_rect, exit_rect);
...
fn fallback_press_release_exit_triggers_exit() {
    ...
    // Simulate a press/release inside the exit button (now at y=128..160)
    ui.test_simulate_press_release((16.0, 136.0), (16.0, 136.0));
    let events = ui.test_collect_fallback_events();
